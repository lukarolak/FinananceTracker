...
public:
  ...
  void set_basic_auth(const stringType& username, const stringType& password);
...
template<typename stringType>
inline void Client::set_basic_auth(const stringType& username, const stringType& password)
{
    cli_->set_basic_auth(username, password);
}

template<typename stringType>
inline void ClientImpl::set_basic_auth(const stringType& username, const stringType& password)
{
